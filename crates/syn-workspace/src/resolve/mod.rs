...
//! crate-internal; the public surface is the resolved model in this file plus
//! [`ReExportIndex`](crate::ReExportIndex), re-exported at the crate root.
...
pub enum Origin {
    ...
    /// Excluded from the SCIP projection and from [`Module::references`] so the
